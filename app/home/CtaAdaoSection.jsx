          ...
          >
            ...
            >
              <motion.a
                ...
                className="tw-inline-flex  tw-px-8 tw-py-4 tw-bg-white tw-text-yellow-700 tw-font-extrabold tw-text-xl tw-rounded-lg tw-shadow-lg tw-transition-all tw-duration-300 tw-ease-in-out tw-transform hover:tw-bg-yellow-600 hover:tw-text-white hover:tw-scale-105 tw-text-center tw-items-center tw-justify-center"
              >
                💎 Stake & Earn Now!
              </motion.a>
            </motion.div>
